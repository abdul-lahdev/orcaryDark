  ...
  return (
    <>
      <div>
        ...
        <div className="border border<-[#303036] rounded-[12px] p-10 flex items-center justify-between mt-5">
          <div>
            <h1 className="text-(--grey1) text-[16px] font-semibold">
              Total Earnings
            </h1>
            <p className="text-(--grey1) text-[14px] font-normal">
              This total represents the total earnings that has not been
              withdrawn.
            </p>
          </div>
          <div className="flex items-center gap-10">
            <h1 className="text-(--grey1) text-[30px] font-semibold">
              $ 457.22
            </h1>
        ...
        <div className="mt-5 w-full rounded-xl border-2 border-(--dark2) bg-(--dark4) p-4">
          <div className="flex items-center justify-between">
            ...
            <select
              name=""
              id=""
              className="text-(--grey1) text-[20px] font-bold"
            >
              <option className="bg-(--dark1) text-(--grey1)" value="lives">
                lives
              </option>
              <option
                className="bg-(--dark1) text-(--grey1)"
                value="virtualClassroom"
              >
                Virtual Classroom
              </option>
              <option className="bg-(--dark1) text-(--grey1)" value="resource">
                Resource
              </option>
            </select>
