    ...
    return (
        ...
        >
            ...
            >
                ...
                {
                    activeBar&&
                        <svg className="mt-2" width="55" height="25" viewBox="0 0 488 510" fill="none" xmlns="http://www.w3.org/2000/svg"> <g clipPath="url(#clip0_149_339)"> <mask id="mask0_149_339" style={{ maskType: 'luminance' }} maskUnits="userSpaceOnUse" x="0" y="0" width="488" height="510"> <path d="M488 0H0V510H488V0Z" fill="white" /> </mask> <g mask="url(#mask0_149_339)"> <path d="M57.9859 74.5696C42.286 83.6337 42.286 106.294 57.9859 115.358L181.624 186.737C197.324 195.802 216.949 184.471 216.949 166.343V23.5843C216.949 5.45617 197.324 -5.87395 181.624 3.19011L57.9859 74.5696Z" fill="#23A5E7" /> <path d="M158.931 236.451C174.632 245.515 174.632 268.176 158.932 277.238L35.2938 348.618C19.5938 357.682 -0.03125 346.354 -0.03125 328.224V185.465C-0.03125 167.337 19.5938 156.007 35.2938 165.071L158.931 236.451Z" fill="#23A5E7" /> <path d="M57.9859 394.33C42.286 403.394 42.286 426.055 57.9859 435.117L181.624 506.496C197.324 515.561 216.949 504.232 216.949 486.103V343.343C216.949 325.217 197.324 313.885 181.624 322.95L57.9859 394.33Z" fill="#23A5E7" /> <path d="M429.932 74.5696C445.632 83.6337 445.632 106.294 429.932 115.358L306.294 186.737C290.594 195.802 270.969 184.471 270.969 166.343V23.5843C270.969 5.45617 290.594 -5.87395 306.294 3.19011L429.932 74.5696Z" fill="#23A5E7" /> <path d="M328.776 234.57C313.075 243.634 313.075 266.295 328.775 275.357L452.413 346.737C468.113 355.801 487.738 344.473 487.738 326.343V183.584C487.738 165.456 468.113 154.126 452.413 163.19L328.776 234.57Z" fill="#23A5E7" /> <path d="M429.932 394.33C445.632 403.394 445.632 426.055 429.932 435.117L306.294 506.496C290.594 515.561 270.969 504.232 270.969 486.103V343.343C270.969 325.217 290.594 313.885 306.294 322.95L429.932 394.33Z" fill="#23A5E7" /> </g> </g> <defs> <clipPath id="clip0_149_339"> <rect width="488" height="510" fill="white" /> </clipPath> </defs> </svg>
